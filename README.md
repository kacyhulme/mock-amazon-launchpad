...
-- added npm install --save node-sass-chokidar
-- added npm run watch-css (watch with npm run watch-css )
-- added ability to skip relative paths with '--include-path' in build-css/watch-css in package.json
-- added bootstrap npm install --save react-bootstrap bootstrap@3
-- added proxy field "proxy": "http://localhost:4000",
